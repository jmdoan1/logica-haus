...
After making a react app and building a single component, I decided to restart with Next.js for a few reasons:
...
Now for the part I've been dreading the most...manually copying over the images and content from SquareSpace...just a big, fat, juicy chunk of time-consuming non-work. Sounds a lot like my entire accounting career smh.
