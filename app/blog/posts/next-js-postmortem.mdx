...
So it looks like the layout page outlines the initial metadata and each page can override whichever value(s) it wants to, which is pretty nifty, and confirmed to be an accurate assessment. After some modifications, the Projects page tab now says "Projects | LogicaHaus"
