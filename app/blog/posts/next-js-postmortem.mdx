...
It's now time to admit that I sold you a lie. I still have not copied all the content from the Squarespace site, but this post won't be published until the website is done, so let's just pretend. I think I'd rather work on the landing page right now anyways
