...
I have also been freelancing since 2016 and find most of my clients through Reddit. Recently, I got a comment on one of my r/forhire posts asking why a full stack developer has a portfolio "Powered by Squarespace". My response was simple and only had 3 points.
...
3. If I'm going to write code, I'd rather be writing the code that's actively making my money.
...
After making a react app and making a single component, I decided to restart with Next.js for a few reasons:
...
Whoops, it loks like I'm having trouble getting this image to display here. I had added the image to a new assets folder within the existing blog folder and tried
...
Unfortunately, a screenshot of nothing but Geist font kind of blended into a blog post full of Geist font, so I decided to test out the components-in-css theory with some css
...
Cool beans, m'queens. \*tips fedora and rides off into the sunset in full sigma fashion\*
...
The quickest and easiest solution here that still looks good is to change `w-[100px]` to `w-[115px]` in the first \<p> component and make sure not to write any articles on future dates that might require more characters. And with that, the finger guns are fully loaded and we have a website that looks like this:
