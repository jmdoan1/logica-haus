...
export default function ApiAnim() {
  return (
        ...
        <g>
          <g>
            ...
            >
              <stop
                offset="0"
                style={{ "stop-color": "#202333" } as React.CSSProperties}
              />
              <stop
                offset="1"
                style={{ "stop-color": "#5C1B99" } as React.CSSProperties}
              />
            </linearGradient>
            <linearGradient
              id="SVGID_2_"
            ...
            >
              ...
              <stop
                offset="1"
                style={{ "stop-color": "#5C6399" } as React.CSSProperties}
              />
            </linearGradient>
        ...
        SUVORK5CYII="
              ...
              <g display="inline">
                ...
                >
                  <stop
                    offset="0"
                    style={{ "stop-color": "#FFFFFF" } as React.CSSProperties}
                  />
                  <stop
                    offset="0.8387"
                    style={
            ...
            <g id="d-app">
              <g>
                ...
                >
                  <stop
                    offset="0"
                    style={{ "stop-color": "#808080" } as React.CSSProperties}
                  />
                  <stop
                    offset="0.2627"
                    style={{ "stop-color": "#6F6F6F" } as React.CSSProperties}
                  />
                  <stop
                    offset="0.7192"
                    style={{ "stop-color": "#575757" } as React.CSSProperties}
                  />
                  <stop
                    offset="1"
                    style={{ "stop-color": "#4E4E4E" } as React.CSSProperties}
                  />
                </linearGradient>
                <path
                  fill="url(#SVGID_7_)"
                ...
                >
                  <stop
                    offset="0"
                    style={{ "stop-color": "#9A9A9A" } as React.CSSProperties}
                  />
                  <stop
                    offset="0.3122"
                    style={{ "stop-color": "#9F9F9F" } as React.CSSProperties}
                  />
                  <stop
                    offset="0.7197"
                    style={{ "stop-color": "#B0B0B0" } as React.CSSProperties}
                  />
                  <stop
                    offset="1"
                    style={{ "stop-color": "#BFBFBF" } as React.CSSProperties}
                  />
                </linearGradient>
                <path
                  fill="url(#SVGID_8_)"
              ...
              <g>
                ...
                >
                  <stop
                    offset="0"
                    style={{ "stop-color": "#A61D30" } as React.CSSProperties}
                  />
                  <stop
                    offset="0.2302"
                    style={{ "stop-color": "#AA2033" } as React.CSSProperties}
                  />
                  <stop
                    offset="0.4367"
                    style={{ "stop-color": "#B4293A" } as React.CSSProperties}
                  />
                  <stop
                    offset="0.634"
                    style={{ "stop-color": "#C73848" } as React.CSSProperties}
                  />
                  <stop
                    offset="0.8245"
                    style={{ "stop-color": "#E04D5A" } as React.CSSProperties}
                  />
                  <stop
                    offset="1"
                    style={{ "stop-color": "#FF6670" } as React.CSSProperties}
                  />
                </linearGradient>
                <path
                  fill="url(#SVGID_9_)"
                ...
                >
                  <stop
                    offset="0"
                    style={{ "stop-color": "#E6455C" } as React.CSSProperties}
                  />
            ...
            <g id="d-apps2">
              ...
              <g>
                ...
                >
                  ...
                  <stop
                    offset="1"
                    style={{ "stop-color": "#FF3D49" } as React.CSSProperties}
                  />
                </linearGradient>
                <path
          ...
          <g id="topgreyblocks" opacity="0.7">
            <g>
              ...
              >
                ...
                <stop
                  offset="0.2961"
                  style={{ "stop-color": "#D3D3D3" } as React.CSSProperties}
                />
                <stop
                  offset="0.604"
                  style={{ "stop-color": "#ABABAB" } as React.CSSProperties}
                />
        ...
        RK5CYII="
          ...
          <g id="redglow">
            ...
            >
              ...
              <stop
                offset="1"
                style={{ "stop-color": "#FF808B" } as React.CSSProperties}
              />
            </linearGradient>
            <polygon
              className="particlespoly"
        ...
        CzAAqYTVOPWO2yYAAAAASUVORK5CYII="
          ...
          <g id="bottomblocks" opacity="0.7">
            ...
            <g>
              ...
              >
                ...
                <stop
                  offset="0.1122"
                  style={{ "stop-color": "#AAAAAE" } as React.CSSProperties}
                />
                <stop
                  offset="0.4064"
                  style={{ "stop-color": "#767884" } as React.CSSProperties}
                />
                <stop
                  offset="0.6631"
                  style={{ "stop-color": "#515366" } as React.CSSProperties}
                />
                <stop
                  offset="0.8695"
                  style={{ "stop-color": "#3A3D54" } as React.CSSProperties}
                />
                <stop
                  offset="1"
                  style={{ "stop-color": "#32354D" } as React.CSSProperties}
                />
              </linearGradient>
              <path
                fill="url(#SVGID_134_)"
          ...
          <g>
            ...
            >
              ...
              <stop
                offset="0.1993"
                style={{ stopColor: "#C5C6D1", stopOpacity: 0.8007 }}
              />
              <stop
                offset="0.3919"
                style={{ stopColor: "#9497AB", stopOpacity: 0.6081 }}
              />
              <stop
                offset="0.5731"
                style={{ stopColor: "#6E728D", stopOpacity: 0.4269 }}
              />
              <stop
                offset="0.7399"
                style={{ stopColor: "#535878", stopOpacity: 0.2601 }}
              />
              <stop
                offset="0.8874"
                style={{ stopColor: "#43486B", stopOpacity: 0.1126 }}
              />
              <stop
                offset="1"
